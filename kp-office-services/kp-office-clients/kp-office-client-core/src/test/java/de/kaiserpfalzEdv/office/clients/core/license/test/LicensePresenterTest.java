...
package de.kaiserpfalzEdv.office.clients.core.license.test;
...
import de.kaiserpfalzEdv.office.clients.core.license.impl.LicenseView;
...
public class LicensePresenterTest extends MockingTestBase {
    ...
    private static final OfficeLicense LICENSE = new LicenseImpl(UUID.randomUUID(), LocalDate.MIN, "Kaiserpfalz EDV-Service", "Unit Tests", LocalDate.MIN, LocalDate.MAX, "KP Office", new SoftwareVersionRange(new SoftwareVersion("0.0.0"), new SoftwareVersion("999.999.999")), new String[]{});
    ...
    protected void setUpService() {
        ...
        client = mockery.mock(LicenseClient.class, "client");
    ...
    public void checkLicenseClientChange() {
        ...
        LicenseClient newClient = mockery.mock(LicenseClient.class, "newLicenseClient");

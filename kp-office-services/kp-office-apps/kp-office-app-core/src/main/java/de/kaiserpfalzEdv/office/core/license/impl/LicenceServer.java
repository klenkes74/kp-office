...
import de.kaiserpfalzEdv.office.core.license.commands.LicenseCommand;
...
public class LicenceServer implements MessageListener {
    ...
    private LicenseCommandExecutorImpl service;
    private MessageConverter           converter;


    @Inject
    public LicenceServer(final RabbitTemplate sender, final LicenseCommandExecutorImpl service, final MessageConverter converter) {
        this.sender = sender;
        ...
        LOG.trace("  license command executor: {}", this.service);
    ...
    public void onMessage(Message message) {
        LicenseCommand command = (LicenseCommand) converter.fromMessage(message);

...
public class PrimaNotaEntryImpl extends PostingRecordImpl implements PrimanotaEntry {
    private static final long serialVersionUID = 6587343376489139467L;
    ...
    public PrimaNotaEntryImpl(
        ...
        super(id, entryId, entryDate, documentNumber, documentDate, documentAmount, accountDebitted, accountCreditted, accountingAmount);
    }
}

 ...
 * @since 2014Q
 */
public class RetrieveCountryCommand extends CountryBaseCommand {
    ...
    public RetrieveCountryCommand() {
    }


    @SuppressWarnings("deprecation")
    public RetrieveCountryCommand(@NotNull final KPOEntityQuery query, @NotNull final PagingRequest paging) {
        setQuery(query);
        setPaging(paging);
    }

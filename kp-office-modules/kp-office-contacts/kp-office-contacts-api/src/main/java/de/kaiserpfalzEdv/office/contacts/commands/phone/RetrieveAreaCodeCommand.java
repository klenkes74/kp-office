 ...
 * @since 2014Q
 */
public class RetrieveAreaCodeCommand extends AreaCodeBaseCommand {
    ...
    public RetrieveAreaCodeCommand() {
    }


    @SuppressWarnings("deprecation")
    public RetrieveAreaCodeCommand(@NotNull final KPOEntityQuery query, @NotNull final PagingRequest paging) {
        setQuery(query);
        setPaging(paging);
    }

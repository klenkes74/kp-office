 ...
 * @since 0.1.0
 */
public class CountryCodeDO implements CountryCode {
    ...
    public CountryCodeDO() {
    }


    public CountryCodeDO(@NotNull final Country country) {
        setCountry(country);
    }

    public CountryCodeDO(@NotNull final CountryCode countryCode) {
        country = (CountryDO) countryCode.getCountry();
    }

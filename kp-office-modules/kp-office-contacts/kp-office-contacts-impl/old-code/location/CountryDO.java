...
import de.kaiserpfalzEdv.office.contacts.address.phone.CountryCodeDO;
 ...
 * @since 0.1.0
 */
public class CountryDO extends KPOEntity implements Country {
    private static final long serialVersionUID = -7059991211039839583L;
    ...
    public CountryDO(@NotNull final UUID id, @NotNull final String displayName, @NotNull final String displayNumber,

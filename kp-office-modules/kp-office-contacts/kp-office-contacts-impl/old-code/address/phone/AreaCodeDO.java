 ...
 * @since 0.1.0
 */
public class AreaCodeDO extends KPOEntity implements AreaCode {
    private static final long serialVersionUID = -7115742775238758512L;

    private CountryCodeDO country;
    ...
    public AreaCodeDO(@NotNull final UUID id,
    ...
    public AreaCodeDO(@NotNull final AreaCode areaCode) {
    ...
    void setCountryCode(@NotNull final CountryCode country) {
        setCountryCode(new CountryCodeDO(country));
    }

    void setCountryCode(@NotNull final CountryCodeDO country) {

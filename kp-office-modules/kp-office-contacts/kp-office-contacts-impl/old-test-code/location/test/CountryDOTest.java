 ...
 */
@Test
public class CountryDOTest extends CommonTestBase {
    private static final Logger LOG = LoggerFactory.getLogger(CountryDOTest.class);


    public CountryDOTest() {
        super(CountryDOTest.class, LOG);
    }

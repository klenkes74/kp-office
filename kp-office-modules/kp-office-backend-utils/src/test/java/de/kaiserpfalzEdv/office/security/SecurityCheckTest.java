...
public class SecurityCheckTest {
    ...
    public static Archive<?> createTestArchive() throws IOException {
        Archive<WebArchive> ear = ShrinkWrap.create(WebArchive.class, "kp-office-test.war")
                .addPackage("de.kaiserpfalzEdv.office.security")
                .addPackage("de.kaiserpfalzEdv.commons.correlation")
...
//                );
    ...
    public void requestLogging() {
        ...
        scm.setInfo(UUID.randomUUID(), UUID.randomUUID(), "meier");

        Assert.assertEquals("meier", scm.getInfo());
    }
}

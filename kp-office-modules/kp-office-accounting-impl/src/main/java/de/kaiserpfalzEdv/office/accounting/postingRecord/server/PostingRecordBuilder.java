...
import de.kaiserpfalzEdv.office.accounting.chartsofaccounts.server.AccountBuilder;
import de.kaiserpfalzEdv.office.accounting.chartsofaccounts.server.AccountImpl;
import de.kaiserpfalzEdv.office.accounting.chartsofaccounts.server.CostCenterBuilder;
...
public class PostingRecordBuilder implements Builder<PostingRecordImpl> {
    ...
    private void calculateDefaults() {
        ...
        document = new de.kaiserpfalzEdv.office.accounting.postingRecord.server.DocumentInformationBuilder()

 ...
 * (not mapped for human use) to the {@link de.kaiserpfalzedv.office.finance.accounting.accounts.ChartedAccount} (that
 * is mapped to a human usable number in a {@link de.kaiserpfalzedv.office.finance.accounting.accounts.ChartOfAccounts})

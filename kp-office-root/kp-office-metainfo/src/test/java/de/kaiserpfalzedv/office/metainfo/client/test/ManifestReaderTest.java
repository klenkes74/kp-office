...
package de.kaiserpfalzedv.office.metainfo.client.test;

import java.util.Optional;

import de.kaiserpfalzedv.office.metainfo.api.ManifestReader;
import de.kaiserpfalzedv.office.metainfo.client.ManifestReaderImpl;
...
public class ManifestReaderTest {
    ...
    public void shouldJoinLinesWhenFollowingLineStartWithSpaces() {
        ...
        assertTrue(result.isPresent());
        assertEquals("https://devzone.kaiserpfalz-edv.de/kp-office/kp-office/kp-office-base-root/kp-office-base-metainfo/", result
                .get());
    }

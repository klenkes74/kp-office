...
public class Tenant extends KPOEntity {
    @SuppressWarnings("UnusedDeclaration")
    private static final long serialVersionUID = -2030366062003505468L;
     ...
     */
    public Tenant(final Tenant orig) {
        this(orig.getId(), orig.getDisplayName(), orig.getDisplayNumber());
    }


    public Tenant(final String number, final String name) {
        this(UUID.randomUUID(), name, number);
    }

    public Tenant(final UUID id, final String number, final String name) {

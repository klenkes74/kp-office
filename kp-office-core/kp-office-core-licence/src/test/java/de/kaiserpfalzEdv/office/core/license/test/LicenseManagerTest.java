...
public class LicenseManagerTest extends SpringTestNGBase {
    private static final Logger LOG = LoggerFactory.getLogger(LicenseManagerTest.class);
    ...
    public LicenseManagerTest() {
        super(LicenseManagerTest.class, LOG);
    }
    ...
    public void testInterceptorWithValidLicense() throws LicensingException {
        logMethod("valid-license", "Check with valid license.");
    ...
    @Test(
            ...
            expectedExceptionsMessageRegExp = "Feature 'not-existing-feature' not licensed in license: 87e7cc68-f844-401a-ac80-2f9d34ed69b9"
    )
    public void testInterceptorWithInvalidLicense() throws LicensingException {
        logMethod("invalid-license", "Check with invalid license.");

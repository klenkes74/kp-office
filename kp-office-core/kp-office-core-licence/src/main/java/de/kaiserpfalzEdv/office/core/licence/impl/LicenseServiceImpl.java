...
import de.kaiserpfalzEdv.office.core.licence.CantLoadLicenseException;
import de.kaiserpfalzEdv.office.core.licence.InvalidKeyDigestException;
import de.kaiserpfalzEdv.office.core.licence.LicenseCheckFailedException;
import de.kaiserpfalzEdv.office.core.licence.LicenseExpiredException;
...
public class LicenseServiceImpl implements LicenseService {
    ...
    @Inject
    public LicenseServiceImpl(@Value("${licence.file}") final String licenseFile) {

...
/**
 * <p>Aspect to check the licence of {@link de.kaiserpfalzEdv.office.commons.ModuleInformation} annotated classes or
 * methods.</p>
 * * 
 * <p>The licensing interceptor intercepts calls to</p>
 * <ol>
 *     <li>classes annotated with {@link de.kaiserpfalzEdv.office.commons.ModuleInformation}.</li>
 *     <li>methods annotated with {@link de.kaiserpfalzEdv.office.commons.ModuleInformation}.</li>
 * </ol>
 * 
...
public class LicenceManager {
    private static final Logger LOG = LoggerFactory.getLogger(LicenceManager.class);
    ...
    public LicenceManager(LicenceService licenceService) {

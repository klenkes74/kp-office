 ...
 */
public class FeatureNotLicensedException extends LicensingException {
    ...
    public FeatureNotLicensedException(final OfficeLicense license, final String featureId) {
        super(FEATURE_NOT_LICENSED, "Feature '" + featureId + "' not licensed in license: " + license.getId());

 ...
 * @since 0.1.0
 */
public class SyncTenantNotification extends UpdateTenantNotification {
    private static final long serialVersionUID = 1L;

    @Deprecated // Only for JAX-B, Jackson, JPA!
    public SyncTenantNotification() {
    }

    public SyncTenantNotification(final SyncTenantCommand command, final Tenant tenant) {

 ...
 */
@Test
public class OfficeLicenseJsonConverterTest extends CommonTestBase {
    private static final Logger LOG = LoggerFactory.getLogger(OfficeLicenseJsonConverterTest.class);
    ...
    //    private static final String       JSON_LICENCE = "{\"license\":{\"id\":\"87e7cc68-f844-401a-ac80-2f9d34ed69b9\",\"issued\":[2015,2,1],\"issuer\":\"Kaiserpfalz EDV-Service\",\"licensee\":\"Roland T. Lichti\",\"starts\":[2015,2,1],\"expires\":[2034,1,31],\"software\":\"KP Office\",\"range\":{\"start\":{\"state\":\"release\",\"version\":[1,0,0]},\"end\":{\"state\":\"release\",\"version\":[1,9999,9999]}},\"modules\":[\"core\",\"projects\",\"documents\",\"accounting\",\"contacts\"]}}";
    private static final ObjectMapper jsonMapper   = getMapper();


    public OfficeLicenseJsonConverterTest() {
        super(OfficeLicenseJsonConverterTest.class, LOG);
    }
    ...
    public void checkDeserialization() throws IOException {
        ...
        OfficeLicense license = jsonMapper.readValue(JSON_LICENCE, OfficeLicense.class);

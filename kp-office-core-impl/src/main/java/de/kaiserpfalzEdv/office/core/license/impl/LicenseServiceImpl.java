...
public class LicenseServiceImpl implements LicenseService {
    ...
    public void init() throws CantLoadKeyException, CantLoadLicenseException, LicenseCheckFailedException, LicenseExpiredException {
        ...
        try {
            ...
            license = new NullLincenseImpl();
        } catch (IllegalArgumentException | IllegalStateException e) {
            LOG.error("Failure reading the license: {}", e.getMessage());
    ...
    private void loadLicenceFile() throws CantLoadLicenseException, LicenseCheckFailedException {
        ...
        try {
            rawLicense.setLicenseEncodedFromFile(f);
    ...
    private void verifyLicenceIsUntouched() throws LicenseCheckFailedException {
        if (licenseLoaded && !rawLicense.isVerified()) {

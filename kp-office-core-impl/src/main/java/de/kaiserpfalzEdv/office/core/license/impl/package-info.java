 ...
 * <code>classpath:/{@value de.kaiserpfalzEdv.office.core.license.impl.LicenceServiceImpl#KEY_RING}</code>. The license
 * file should be configures via <code>application.properties</code>. As fallback a file named
 * {@value de.kaiserpfalzEdv.office.core.license.impl.LicenceServiceImpl#LICENSE_FILE} in the startup directory of the
 * software is used.</p>
 *
 * <p>The license check is annotated per aspect {@link de.kaiserpfalzEdv.office.core.license.impl.LicenceManager} to

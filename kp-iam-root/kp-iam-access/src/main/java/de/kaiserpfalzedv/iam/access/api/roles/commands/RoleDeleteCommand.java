 ...
 * @since 2017-11-19
 */
public class RoleDeleteCommand extends RoleBaseCommand {
    private static final long serialVersionUID = -2490121783163018522L;
    ...
    public RoleDeleteCommand(
            ...
            @NotNull @JsonProperty("role") final UUID role
    ) {
        super(source, command, CrudCommandType.DELETE);

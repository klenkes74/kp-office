 ...
 * @since 2017-11-19
 */
public class EntitlementCreateReply extends EntitlementBaseReply {
    private static final long serialVersionUID = 8052862758684939157L;

    private Entitlement data;

    @JsonCreator
    public EntitlementCreateReply(
            ...
            @NotNull @JsonProperty("entitlement") final Entitlement data
    ) {

 ...
 * @since 2017-11-19
 */
public class RoleCreateReply extends RoleBaseReply {
    private static final long serialVersionUID = 559046357211226629L;

    private Role role;

    @JsonCreator
    public RoleCreateReply(
            ...
            @NotNull @JsonProperty("role") final Role data
    ) {

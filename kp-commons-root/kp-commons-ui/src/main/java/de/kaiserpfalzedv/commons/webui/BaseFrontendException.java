 ...
 * @since 2017-11-01
 */
public class BaseFrontendException extends BaseBusinessException {
    private static final long serialVersionUID = 4998866554263204375L;

    private String captionKey;
    private String descriptionKey;
    private Object[] data;

    public BaseFrontendException(

...
/**
 * A bigger module of the software. May come with a software license of its own and therefore with an
 * own {@link ApplicationLicense technical license}.
 *
...
public interface OfficeModule extends Identifiable, Nameable, Serializable {
     ...
     */
    Optional<ApplicationLicense> getLicense();
}

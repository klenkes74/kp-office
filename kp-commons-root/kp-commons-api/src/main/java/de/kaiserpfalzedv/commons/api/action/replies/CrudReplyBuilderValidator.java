 ...
 * @since 2017-11-19
 */
public interface CrudReplyBuilderValidator<T extends Serializable> {
    List<String> validateId(
            @NotNull final CrudCommand<T> command, @NotNull final UUID replyId,
            @NotNull final UUID dataId, @NotNull final T data, @NotNull PagedListable<T> datalist
    );

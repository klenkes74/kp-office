...
public class DefaultTenantTest {
    ...
    public void testGetDisplayname() throws Exception {
        assertEquals("The display name should be empty!", "Standardmandant", tenant.getDisplayName());
    }

    @Test
    public void testGetFullname() throws Exception {
        assertEquals("The full name should be empty!", "Systemmandant", tenant.getFullName());
    }

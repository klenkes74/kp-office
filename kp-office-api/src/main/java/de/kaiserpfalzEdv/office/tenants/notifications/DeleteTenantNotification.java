 ...
 * @since 0.1.0
 */
public class DeleteTenantNotification extends UpdateTenantNotification {
    private static final long serialVersionUID = 1L;

    @Deprecated // Only for JAX-B, Jackson, JPA!
    public DeleteTenantNotification() {}


    public DeleteTenantNotification(DeleteTenantCommand command, Tenant tenant) {

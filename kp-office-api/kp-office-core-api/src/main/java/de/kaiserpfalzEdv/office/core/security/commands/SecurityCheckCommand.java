 ...
 */
public class SecurityCheckCommand implements SecurityCommand {
    private static final long serialVersionUID = 304563448884106712L;


    private OfficeLoginTicket ticket;


    public SecurityCheckCommand(final OfficeLoginTicket ticket) {
        this.ticket = ticket;
    }
    ...
    public boolean equals(Object obj) {
        ...
        SecurityCheckCommand rhs = (SecurityCheckCommand) obj;

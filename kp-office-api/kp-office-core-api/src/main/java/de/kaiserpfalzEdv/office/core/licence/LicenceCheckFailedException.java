 ...
 */
public class LicenceCheckFailedException extends LicencingException {
    ...
    public LicenceCheckFailedException(final String licenseFile) {
        super(LICENSE_INVALID, LICENSE_INVALID.getMessage() + ": " + licenseFile);

        this.fileName = licenseFile;
    }

    public LicenceCheckFailedException(final String licenseFile, final Throwable cause) {

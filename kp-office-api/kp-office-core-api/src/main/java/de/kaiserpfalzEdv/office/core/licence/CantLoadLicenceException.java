 ...
 */
public class CantLoadLicenceException extends LicencingException {
    ...
    public CantLoadLicenceException(final String licenseFile) {
        super(CANT_LOAD_LICENSE, CANT_LOAD_LICENSE.getMessage() + ": " + licenseFile);

        this.fileName = licenseFile;
    }

    public CantLoadLicenceException(final String licenseFile, final Throwable cause) {

...
public class FiscalYearImpl extends KPOTenantHoldingEntity implements FiscalYear {
    ...
    public FiscalYearImpl(@NotNull final UUID tenantId, @NotNull final UUID id, @NotNull final int year) {
        this(
                tenantId, id,
                LocalDate.of(year, 1, 1),
                FiscalYear.DEFAULT_LENGTH, FiscalYear.DEFAULT_MIN_PERIOD, FiscalYear.DEFAULT_MAX_PERIODS
        );
    }
    ...
    public FiscalYearImpl(
        ...
        super(id, String.format("Fiscal Year %d", start.getYear()), Integer.toString(start.getYear()), tenantId);

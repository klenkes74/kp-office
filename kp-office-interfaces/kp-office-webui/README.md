...
- kp-office-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- kp-office-ui: main application module, development time
- kp-office-production: module that produces a production mode WAR for deployment

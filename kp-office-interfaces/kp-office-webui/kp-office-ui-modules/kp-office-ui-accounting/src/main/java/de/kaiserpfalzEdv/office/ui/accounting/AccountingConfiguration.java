...
import de.kaiserpfalzEdv.office.accounting.chartsofaccounts.AccountMappingImpl;
...
import de.kaiserpfalzEdv.office.accounting.chartsofaccounts.ChartsOfAccountsImpl;
...
public class AccountingConfiguration {
    ...
    public AccountMapping d03Mapping() {
        AccountMappingImpl result = new AccountMappingImpl("6c4a5120-088a-4321-a8e1-5d0c22a4b436", "Default Chart of Accounts Type 03");
    ...
    public AccountMapping d04Mapping() {
        AccountMappingImpl result = new AccountMappingImpl("fbee614d-daf0-43a6-890d-16125be27f75", "Default Chart of Accounts Type 04");
    ...
    public ChartsOfAccounts accounts() {
        ChartsOfAccountsImpl result = new ChartsOfAccountsImpl(UUID.fromString("cf5f01fb-83c7-4352-80bd-681163956786"), "Internal Chart Of Accounts");

        ArrayList<Account> accounts = new ArrayList<>(3);
        accounts.add(
                new AccountBuilder().withId(UUID.fromString("ddb684b8-501c-47fc-a46c-7990110bf092"))
                                    .withName("Bank")
                                    .build()
        );
        accounts.add(
                new AccountBuilder().withId(UUID.fromString("cb488173-b9b0-4f37-adb1-385d2051363e"))
                                    .withName("Privat R. Lichti")
                                    .withDescription("Privatkonto Roland Lichti")
                                    .build()
        );
        accounts.add(
                new AccountBuilder().withId(UUID.fromString("804327a3-50f7-4f2c-8ca0-1c3cd502b1ab"))

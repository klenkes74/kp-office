 ...
 */
public class LoadUserEvent extends BaseLoadDataEvent {
    private static final long serialVersionUID = -6328518451928528415L;

    public LoadUserEvent(Object source, Long payload) {

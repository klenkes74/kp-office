...
import de.kaiserpfalzEdv.office.clients.core.about.AboutPanel;
...
public class AboutPanelImpl extends VerticalLayout implements AboutPanel, View, Component {
    ...
    public AboutPanelImpl(final ApplicationMetaData applicationData, final OfficeLicense license) {

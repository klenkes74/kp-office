...
package de.kaiserpfalzEdv.office.ui.web.api.content;
...
import de.kaiserpfalzEdv.office.ui.web.api.widgets.content.events.ReplaceMainTabEvent;
...
public class ContentTabBuilder implements Builder<ContentTab> {
    ...
    public AddMainTabEvent addMainTabEvent() {
        return new AddMainTabEvent(this, build());
    }

    public ReplaceMainTabEvent replaceMainTabEvent() {
        return new ReplaceMainTabEvent(this, build());
    }
    ...
    public RemoveMainTabEvent removeMainTabEvent() {
        ...
        return new RemoveMainTabEvent(this, id);

...
import de.kaiserpfalzEdv.office.ui.core.license.LicensePresenter;
...
public class LicenseView extends CssLayout implements de.kaiserpfalzEdv.office.ui.core.license.LicenseView, View, Component {
    ...
    @Override
    public void setLicense(@NotNull final OfficeLicence license) {

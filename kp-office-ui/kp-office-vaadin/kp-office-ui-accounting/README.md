...
- kp-office-ui-accounting-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- kp-office-ui-accounting-ui: main application module, development time
- kp-office-ui-accounting-production: module that produces a production mode WAR for deployment

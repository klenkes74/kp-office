...
package de.kaiserpfalzedv.office.common.client;
...
public class ClientCommunicationException extends BaseSystemException {
    private static final long serialVersionUID = -5195809999522750874L;
    ...
    public ClientCommunicationException(final Class<?> clasz, final CrudCommands command, final UUID correlationId, final String messageId, final UUID objectId, Throwable cause) {
        super(String.format(
    ...
    public ClientCommunicationException(final Class<?> clasz, final CrudCommands command, final UUID correlationId, final String messageId, Throwable cause) {
        super(String.format(

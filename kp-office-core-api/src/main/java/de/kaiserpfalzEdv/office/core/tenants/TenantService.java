...
public interface TenantService {
     ...
     */
    void create(@NotNull final Tenant tenant) throws TenantAlreadyExistsException;
    ...
    Tenant retrieve(@NotNull final UUID id) throws NoSuchTenantException, OnlyInvalidTenantFoundException;
     ...
     */
    @SuppressWarnings("DuplicateThrows")
    Tenant retrieve(@NotNull final String displayNumber) throws NoSuchTenantException, OnlyInvalidTenantFoundException;
     ...
     * @throws NoSuchTenantException There is no tenant with the given ID.
     */
    void update(@NotNull final UUID id, @NotNull final Tenant tenant) throws NoSuchTenantException;
     ...
     */
    void delete(@NotNull final Tenant tenant);
     ...
     * @return the given page of tenants.
     */
    Page<Tenant> listTenants(Tenant tenant, Pageable pageable);
     ...
     * @return the given page of tenants.
     */
    Page<Tenant> listTenants(UUID tenant, Pageable pageable);
}

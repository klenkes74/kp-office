...
package de.kaiserpfalzEdv.office.core.license.notifications;
...
public class LicenseDataNotification implements Notification {
    ...
    public LicenseDataNotification(@JsonProperty("license") final OfficeLicense licence) {
        this.licence = licence;
    }


    @JsonProperty("license")
    public OfficeLicense getLicence() {
        return licence;
    }
    ...
    public boolean equals(Object obj) {
        ...
        LicenseDataNotification rhs = (LicenseDataNotification) obj;

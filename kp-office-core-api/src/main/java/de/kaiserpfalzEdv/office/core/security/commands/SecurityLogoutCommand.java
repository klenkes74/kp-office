 ...
 * @author klenkes
 * @version 2015Q1
 * @since 01.03.15 20:09
 */
public class SecurityLogoutCommand implements SecurityCommand {
    private static final long serialVersionUID = 4748454055722960310L;


    private OfficeLoginTicket ticket;


    public SecurityLogoutCommand(final OfficeLoginTicket ticket) {
        this.ticket = ticket;
    }
    ...
    public boolean equals(Object obj) {
        ...
        SecurityLogoutCommand rhs = (SecurityLogoutCommand) obj;

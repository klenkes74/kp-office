 ...
 * @since 2017-10-30
 */
public class OfficeLicenseBuilder implements Builder<ApplicationLicense> {
    ...
    public ApplicationLicense build() {
        ...
        return new ApplicationLicenseImpl(license, duration, versions);
    }
    ...
    private License generateBaseLicense() {
        ...
        try {
            ...
            throw new BuilderException(ApplicationLicenseImpl.class, new String[]{"Can't load licensor file. Did you play with the library files? Reason: " + e
                    .getMessage()});
        } finally {
            if (licensor != null) {
                try {
        ...
        try {
            ...
            throw new BuilderException(ApplicationLicenseImpl.class, new String[]{" Can't load license file: " + licenseFile});
        } catch (PGPException e) {
            throw new BuilderException(ApplicationLicenseImpl.class, new String[]{"Can't decode and validate license file: " + licenseFile});
        }
    ...
    private void validate(@NotNull final License license) {
        ...
        if (failures.size() > 0) {
            throw new BuilderException(ApplicationLicenseImpl.class, failures);
        }
    }
